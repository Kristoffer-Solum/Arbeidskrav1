...
En rekke konfunderende faktorer kan påvirke utfallet av testene (Halperin, Pyne & Martin, 2015). Av konfunderende faktorer er hvor godt forberedt forsøksperson er, treningsstatus, næringsinntak før testing, hvor gode instruksjoner man får før testing, verbal oppmuntring, hvor mange som er til stede i testlokalet, musikk i rommet og psykologiske faktorer (Halperin et al. 2015).
...
Basset, D. R., & Howley, E. T. (2000, Januar). Limiting factors or maximum oxygen uptake and determinants of endurance performance. Medicine & Science in Sports & Exercise, ss.70-84

Halperin I, Pyne DB, Martin DT. Threats to Internal Validity in Exercise Science: A Review of Overlooked Confounding Variables. International Journal of Sports Physiology and Performance. oktober 2015;10(7):823–9.
